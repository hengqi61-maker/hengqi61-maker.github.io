...
export const summerCamps = {
  ...
  title: "2026 夏令营与预推免进展",
  subtitle:
    "Current summer-camp and pre-admission interview status, kept concise for supervisors and reviewers.",
  statement:
    "当前仅保留南方科技大学作为研究生阶段去向之一；同时，我已进入复旦大学现代物理研究所预推免复试环节。后续会根据复试交流、导师沟通和研究方向匹配情况继续更新。",
  rows: [
    {
      school: "南方科技大学物理系",
      ...
      status: "保留去向之一",
      statusKey: "done",
      note: "已完成线下交流，当前仍作为研究生阶段候选去向之一，后续根据导师沟通和匹配度继续评估。",
    },
    {
      school: "复旦大学现代物理研究所",
      program: "2027年推免生预推免复试",
      time: "2026年8月24日-8月25日",
      status: "已进入复试",
      statusKey: "upcoming",
      note: "已收到复旦大学现代物理研究所邮件通知，复试地点为复旦大学邯郸校区现代物理研究所。",
    },
  ],
};
